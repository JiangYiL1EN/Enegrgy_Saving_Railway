...
%     plot([S1(end),S3(1)],[E2,E2],'r-', 'LineWidth',2);
    E1_new=cumsum(E1);E2_new=E1_new(end)+f2*v1*t3;;
    plot([S1,S3(1),5144.7],[E1_new,E2_new,E2_new],'Color',col, 'LineStyle',mak,'Marker',mak2, 'LineWidth',2);
end
