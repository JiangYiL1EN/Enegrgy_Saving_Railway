...
%牵引力
    plot([S1,S2,S2(end),S4(1),S4],[F1,F2,0,0,F4],'Color',col,  'LineStyle',mak,'Marker',mak2,'LineWidth',2);
%制动力
%     plot([S4(1),S4(end)],[Stopmax,Stopmax],'Color',col,  'LineStyle',mak,'Marker',mak2,'LineWidth',2)
end
legend('206s','216s','226s','256s','356s','506s','FontSize', 16);
set(gca, 'FontSize', 12);
xlim([0, 5200]);
% ylim([0,30]);
