...
for i=1:1:n
   ...
   %制动时间计算
    ...
    mak2=Maks(i);
%     a=a+1;
%     plot(S1,A,'Color',col, 'LineWidth',2);
%     plot([S1(end),S3(1)],[v1,v1],'Color',col, 'LineWidth', 2);
%     plot(S3,C,'Color',col, 'LineWidth', 2);
%     plot(S4,D,'Color',col, 'LineWidth', 2);
    plot([S1,S3,S4],[A,C,D],'Color',col, 'LineStyle',mak,'Marker',mak2,'LineWidth',3.5)
end
